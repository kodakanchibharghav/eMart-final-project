package com.project.loginservice.dao.entity;
...
public class BillEntity {
	...
	public BillEntity(int billId, BuyerSignupEntity buyer, String billType, Date billDate, String billRemarks,
	...
	public String toString() {
		return "BillEntity [billId=" + billId + ", buyer=" + buyer + ", billType=" + billType + ", billDate=" + billDate
				+ ", billRemarks=" + billRemarks + ", billAmount=" + billAmount + ", allBillDetails=" + allBillDetails
				+ "]";
	}
}
